...
| `--manual_hov`, `-s` | float | `None` | Manually input `[bid ask last]` for HOV leg at SPY spot S₀ |
| `--manual_lov`, `-l` | float | `None` | Manually input `[bid ask last]` for LOV leg at SPY spot S₀ |
